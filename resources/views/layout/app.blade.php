...
<body class="bg-gray-100 font-sans w-full min-h-screen m-0">
        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between py-5">
                ...
                <div class="hidden sm:flex sm:items-center">
                    ...
                    <a href="#" class="text-gray-800 text-base font-semibold hover:text-purple-600">GitHub</a>
                </div>
                ...
                @auth
                    <div class="hidden sm:flex sm:items-center">
                        ...
                        <a href="{{ route('listing.create') }}"
                            class="text-white text-base font-semibold border px-4 py-2 rounded-lg hover:text-white-600 hover:border-purple-600 bg-violet-500">Add
                            Project</a>
                    </div>
                @else
                    <div class="hidden sm:flex sm:items-center">
                        <a href="{{ route('user.register') }}"
                            class="text-gray-800 text-base font-semibold hover:text-purple-600 mr-4">Sign up</a>
    ...
    {{-- MAIN SECTION --}}
    <main class="mt-20 max-w-6xl mx-auto sm:px-6 lg:px-4">
        @yield('content')
    </main>
